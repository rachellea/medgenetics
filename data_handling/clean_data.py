...
class CleanGenetics(object):
    """Return two dataframes, healthy and pathologic, which contain the cleaned
    genetic data. Furthermore, create an output file 'data_cleaning_history.csv'
    which documents what was filtered out of the original data, and why."""
    def __init__(self, healthy_file, pathologic_file):
        """<healthy_file> and <pathologic_file> are paths to CSVs with columns
        ['Consensus','Position','Change']   """
